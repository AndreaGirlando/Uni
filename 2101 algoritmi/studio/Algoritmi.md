1. [[#Introduzione alla ricorsione|Introduzione alla ricorsione]]
			1. [[#La ricorsione|La ricorsione]]
			2. [[#Fasi della ricorsione|Fasi della ricorsione]]
			3. [[#Definizioni ricorsive delle strutture dati|Definizioni ricorsive delle strutture dati]]
			4. [[#Struttura generale di un programma ricorsivo|Struttura generale di un programma ricorsivo]]
			5. [[#Dimensione del problema|Dimensione del problema]]
			6. [[#L'equazione di ricorrenza|L'equazione di ricorrenza]]
			7. [[#Costruzione di una equazione di ricorrenza|Costruzione di una equazione di ricorrenza]]
2. [[#Applicazioni pratiche della ricorsione|Applicazioni pratiche della ricorsione]]
			1. [[#Il fattoriale|Il fattoriale]]
			2. [[#Moltiplicazione come somma ripetuta|Moltiplicazione come somma ripetuta]]
			3. [[#Potenza con moltiplicazione ripetuta|Potenza con moltiplicazione ripetuta]]
3. [[#Problemi di somma e soglia su array|Problemi di somma e soglia su array]]
			1. [[#Premessa|Premessa]]
			2. [[#Somma dei valori di un array|Somma dei valori di un array]]
			3. [[#Verificare se la somma supera una soglia|Verificare se la somma supera una soglia]]
4. [[#Approccio ricorsivo e iterativo|Approccio ricorsivo e iterativo]]
			1. [[#Analisi|Analisi]]
			2. [[#Versione 0.1: pesi unitari, valori diversi|Versione 0.1: pesi unitari, valori diversi]]
			3. [[#Versione generale 0/1: pesi e valori variabili|Versione generale 0/1: pesi e valori variabili]]
			4. [[#Esercizi sulla ricorsione|Esercizi sulla ricorsione]]
5. [[#Concetti preliminari di analisi asintotica|Concetti preliminari di analisi asintotica]]
			1. [[#Confronto tra le principali funzioni di crescita|Confronto tra le principali funzioni di crescita]]
			2. [[#Confronto tra le principali funzioni di crescita|Confronto tra le principali funzioni di crescita]]
			3. [[#Termini e fattori dominanti e trascurabili|Termini e fattori dominanti e trascurabili]]
6. [[#Le notazioni asintotiche|Le notazioni asintotiche]]
			1. [[#La notazione Θ (theta)|La notazione Θ (theta)]]
			2. [[#La notazione O (Big-Oh)|La notazione O (Big-Oh)]]
			3. [[#La notazione Ω (Big-Omega)|La notazione Ω (Big-Omega)]]
			4. [[#Le notazioni o e ω (piccole)|Le notazioni o e ω (piccole)]]
			5. [[#Conclusioni sulle notazioni asintotiche|Conclusioni sulle notazioni asintotiche]]
7. [[#Oltre i casi limite|Oltre i casi limite]]
			1. [[#Cosa accade davvero in pratica|Cosa accade davvero in pratica]]
			2. [[#Quando le costanti contano|Quando le costanti contano]]
8. [[#Introduzione alle equazioni di ricorrenza|Introduzione alle equazioni di ricorrenza]]
			1. [[#Definizione|Definizione]]
			2. [[#Risoluzione dell'equazione di ricorrenza|Risoluzione dell'equazione di ricorrenza]]
9. [[#Identificare l'equazione di ricorrenza|Identificare l'equazione di ricorrenza]]
			1. [[#Fasi della ricorsione|Fasi della ricorsione]]
			2. [[#Esempio - Ricerca binaria|Esempio - Ricerca binaria]]
10. [[#Ricorrenze non uniformi|Ricorrenze non uniformi]]
			1. [[#Esempio - QuickSort|Esempio - QuickSort]]
			2. [[#Analisi|Analisi]]
11. [[#Il metodo dell'albero di ricorsione|Il metodo dell'albero di ricorsione]]
			1. [[#Notazione|Notazione]]
			2. [[#Analisi|Analisi]]
			3. [[#Esempi|Esempi]]
12. [[#Il metodo della sostituzione|Il metodo della sostituzione]]
			1. [[#Definizione|Definizione]]
			2. [[#Step da seguire|Step da seguire]]
			3. [[#Esempi|Esempi]]
13. [[#Metodo basato sul teorema Master|Metodo basato sul teorema Master]]
			1. [[#Definizione|Definizione]]
			2. [[#Enunciato del teorema Master|Enunciato del teorema Master]]
			3. [[#Interpretazione intuitiva|Interpretazione intuitiva]]
			4. [[#Confronto tra funzioni|Confronto tra funzioni]]
			5. [[#Esempi|Esempi]]
14. [[#Introduzione|Introduzione]]
			1. [[#Caratteristiche principali|Caratteristiche principali]]
			2. [[#Esempio - il pronto soccorso|Esempio - il pronto soccorso]]
15. [[#Confronto con altre implementazioni delle code con priorità|Confronto con altre implementazioni delle code con priorità]]
			1. [[#Specifiche iniziali|Specifiche iniziali]]
			2. [[#Vs Array Disordinato|Vs Array Disordinato]]
			3. [[#Vs Array Ordinato|Vs Array Ordinato]]
			4. [[#Vs Alberi Binari di Ricerca Bilanciati (BBST)|Vs Alberi Binari di Ricerca Bilanciati (BBST)]]
16. [[#Come è fatto uno Heap|Come è fatto uno Heap]]
			1. [[#Introduzione|Introduzione]]
			2. [[#Tipi di Heap|Tipi di Heap]]
17. [[#Operazioni sullo Heap|Operazioni sullo Heap]]
			1. [[#Minimo|Minimo]]
			2. [[#Decrease Key (Decremento di una chiave)|Decrease Key (Decremento di una chiave)]]
			3. [[#Inserimento|Inserimento]]
			4. [[#Procedura Heapify(i):|Procedura Heapify(i):]]
			5. [[#Estrazione del Minimo|Estrazione del Minimo]]
18. [[#Heap usando un array|Heap usando un array]]
			1. [[#Funzioni left, right, parent|Funzioni left, right, parent]]
			2. [[#Heapify|Heapify]]
			3. [[#Insert|Insert]]
			4. [[#Extract-min|Extract-min]]
19. [[#Costruzione dello Heap|Costruzione dello Heap]]
			1. [[#Metodo 1: Inserimenti successivi|Metodo 1: Inserimenti successivi]]
			2. [[#Metodo 2: Procedura Build-Min-Heap (Ottimizzata)|Metodo 2: Procedura Build-Min-Heap (Ottimizzata)]]
			3. [[#Metodo 3: procedura Build-Max-Heap|Metodo 3: procedura Build-Max-Heap]]
20. [[#Heapsort|Heapsort]]
			1. [[#Analisi|Analisi]]
			2. [[#Algoritmo e implementazione|Algoritmo e implementazione]]
21. [[#Esami|Esami]]
22. [[#Limiti degli ordinamenti con confronti|Limiti degli ordinamenti con confronti]]
23. [[#Limiti degli ordinamenti con confronti#Albero di decisione|Albero di decisione]]
			1. [[#Definizione|Definizione]]
			2. [[#Esempio|Esempio]]
24. [[#Limiti degli ordinamenti con confronti#Teorema e dimostrazione|Teorema e dimostrazione]]
			1. [[#Teorema|Teorema]]
			2. [[#Dimostrazione|Dimostrazione]]
			3. [[#Conclusioni|Conclusioni]]
25. [[#Limiti degli ordinamenti con confronti#Counting sort|Counting sort]]
			1. [[#Premesse|Premesse]]
			2. [[#Algoritmo|Algoritmo]]
			3. [[#Implementazione|Implementazione]]
			4. [[#Complessità|Complessità]]
26. [[#Limiti degli ordinamenti con confronti#Radix sort|Radix sort]]
			1. [[#Premesse|Premesse]]
			2. [[#Algoritmo|Algoritmo]]
			3. [[#Implementazione|Implementazione]]
			4. [[#Complessità|Complessità]]
27. [[#Limiti degli ordinamenti con confronti#Introduzione alle Hash table|Introduzione alle Hash table]]
			1. [[#Cos'è un dizionario?|Cos'è un dizionario?]]
			2. [[#Possibili implementazioni e complessità con strutture già note|Possibili implementazioni e complessità con strutture già note]]
28. [[#Limiti degli ordinamenti con confronti#Tabelle a Indirizzamento Diretto|Tabelle a Indirizzamento Diretto]]
			1. [[#Definizione|Definizione]]
			2. [[#Implementazione|Implementazione]]
			3. [[#Svantaggi di questa struttura|Svantaggi di questa struttura]]
29. [[#Limiti degli ordinamenti con confronti#Funzione hashing|Funzione hashing]]
			1. [[#Definizione|Definizione]]
			2. [[#Collisioni|Collisioni]]
30. [[#Limiti degli ordinamenti con confronti#Implementazioni delle tabelle hash|Implementazioni delle tabelle hash]]
			1. [[#Metodo della divisione|Metodo della divisione]]
			2. [[#Metodo della moltiplicazione|Metodo della moltiplicazione]]
31. [[#Limiti degli ordinamenti con confronti#Risolviamo le collisioni usando l'hashing con concatenazione|Risolviamo le collisioni usando l'hashing con concatenazione]]
			1. [[#Definizione|Definizione]]
			2. [[#Implementazioni|Implementazioni]]
			3. [[#Analisi|Analisi]]
32. [[#Limiti degli ordinamenti con confronti#Risolviamo le collisioni usando l'hashing a indirizzamento aperto|Risolviamo le collisioni usando l'hashing a indirizzamento aperto]]
			1. [[#Definizione|Definizione]]
		1. [[#Sequenza di ispezione|Sequenza di ispezione]]
			1. [[#Sequenza di ispezione#Implementazioni funzioni di base|Implementazioni funzioni di base]]
		2. [[#Funzione di cancellazione|Funzione di cancellazione]]
			1. [[#Funzione di cancellazione#Requisiti di una funzioni hash per indirizzamento aperto|Requisiti di una funzioni hash per indirizzamento aperto]]
			2. [[#Funzione di cancellazione#Analisi|Analisi]]
33. [[#Limiti degli ordinamenti con confronti#Tecniche per creare una sequenza di ispezione|Tecniche per creare una sequenza di ispezione]]
			1. [[#Funzione di cancellazione#Ispezione lineare|Ispezione lineare]]
			2. [[#Funzione di cancellazione#Ispezione quadratica|Ispezione quadratica]]
			3. [[#Funzione di cancellazione#Ispezione doppio hashing|Ispezione doppio hashing]]
34. [[#Limiti degli ordinamenti con confronti#Alberi bilanciati|Alberi bilanciati]]
			1. [[#Funzione di cancellazione#Definizione di albero bilanciato|Definizione di albero bilanciato]]
			2. [[#Funzione di cancellazione#Ripasso proprietà del BST|Ripasso proprietà del BST]]
35. [[#Limiti degli ordinamenti con confronti#Proprietà di una albero rosso-nero|Proprietà di una albero rosso-nero]]
			1. [[#Funzione di cancellazione#Proprietà di un albero rosso-nero|Proprietà di un albero rosso-nero]]
			2. [[#Funzione di cancellazione#Rappresentazione di un albero rosso-nero|Rappresentazione di un albero rosso-nero]]
			3. [[#Funzione di cancellazione#Definizione altezza nera lemma altezza massima|Definizione altezza nera lemma altezza massima]]
36. [[#Limiti degli ordinamenti con confronti#Operazioni negli alberi rosso-neri: rotazioni|Operazioni negli alberi rosso-neri: rotazioni]]
			1. [[#Funzione di cancellazione#Definizione|Definizione]]
			2. [[#Funzione di cancellazione#Esempi|Esempi]]
37. [[#Limiti degli ordinamenti con confronti#Operazioni negli alberi rosso-neri: inserimento|Operazioni negli alberi rosso-neri: inserimento]]
			1. [[#Funzione di cancellazione#Definizione|Definizione]]
			2. [[#Funzione di cancellazione#Definizione di insert-fixup|Definizione di insert-fixup]]
			3. [[#Funzione di cancellazione#Esempio|Esempio]]
38. [[#Limiti degli ordinamenti con confronti#Operazioni negli alberi rosso-neri: eliminazione|Operazioni negli alberi rosso-neri: eliminazione]]
			1. [[#Funzione di cancellazione#Ripasso rimozione negli alberi BST|Ripasso rimozione negli alberi BST]]
			2. [[#Funzione di cancellazione#Definizione|Definizione]]
			3. [[#Funzione di cancellazione#Definizione delete-fixup|Definizione delete-fixup]]
39. [[#Limiti degli ordinamenti con confronti#Introduzione|Introduzione]]
			1. [[#Funzione di cancellazione#Definizione|Definizione]]
			2. [[#Funzione di cancellazione#Sviluppare un algoritmo di programmazione dinamica|Sviluppare un algoritmo di programmazione dinamica]]
40. [[#Limiti degli ordinamenti con confronti#Fibonacci|Fibonacci]]
			1. [[#Funzione di cancellazione#Definizione|Definizione]]
			2. [[#Funzione di cancellazione#Analisi|Analisi]]
41. [[#Limiti degli ordinamenti con confronti#Rod-cutting|Rod-cutting]]
			1. [[#Funzione di cancellazione#Definzione|Definzione]]
			2. [[#Funzione di cancellazione#Generalizzando|Generalizzando]]
			3. [[#Funzione di cancellazione#Implementazione bottom-up del ROD-CUT con memorizzazione|Implementazione bottom-up del ROD-CUT con memorizzazione]]
			4. [[#Funzione di cancellazione#Sottostruttura ottima|Sottostruttura ottima]]
42. [[#Limiti degli ordinamenti con confronti#Ottimizzazione della moltiplicazione tra matrici|Ottimizzazione della moltiplicazione tra matrici]]
			1. [[#Funzione di cancellazione#Definizione della moltiplicazione tra matrici|Definizione della moltiplicazione tra matrici]]
			2. [[#Funzione di cancellazione#Analizziamo la complessità|Analizziamo la complessità]]
			3. [[#Funzione di cancellazione#Fasi della programmazione dinamica|Fasi della programmazione dinamica]]
			4. [[#Funzione di cancellazione#Complessità|Complessità]]
43. [[#Limiti degli ordinamenti con confronti#Distanza di Editing|Distanza di Editing]]
			1. [[#Funzione di cancellazione#Introduzione al Problema|Introduzione al Problema]]
			2. [[#Funzione di cancellazione#Definizione Formale e Ricorsiva|Definizione Formale e Ricorsiva]]
			3. [[#Funzione di cancellazione#Programmazione Dinamica|Programmazione Dinamica]]
			4. [[#Funzione di cancellazione#Ricostruzione della Soluzione Ottima|Ricostruzione della Soluzione Ottima]]
44. [[#Limiti degli ordinamenti con confronti#Longest Common Substring|Longest Common Substring]]
			1. [[#Funzione di cancellazione#Sottostruttura ottima:|Sottostruttura ottima:]]
			2. [[#Funzione di cancellazione#Definizione funzione ricorsiva:|Definizione funzione ricorsiva:]]
			3. [[#Funzione di cancellazione#Soluzione con programmazione dinamica:|Soluzione con programmazione dinamica:]]
45. [[#Limiti degli ordinamenti con confronti#Longest Common Subsequence (LCS)|Longest Common Subsequence (LCS)]]
			1. [[#Funzione di cancellazione#Sottostruttura ottima|Sottostruttura ottima]]
			2. [[#Funzione di cancellazione#Definizione funzione ricorsiva|Definizione funzione ricorsiva]]
			3. [[#Funzione di cancellazione#Soluzione con programmazione dinamica|Soluzione con programmazione dinamica]]
46. [[#Limiti degli ordinamenti con confronti#Introduzione|Introduzione]]
			1. [[#Funzione di cancellazione#Definizione|Definizione]]
47. [[#Limiti degli ordinamenti con confronti#Problema dello zaino|Problema dello zaino]]
			1. [[#Funzione di cancellazione#Definizione|Definizione]]
			2. [[#Funzione di cancellazione#Dimostrazione scelta greedy|Dimostrazione scelta greedy]]
48. [[#Limiti degli ordinamenti con confronti#Compressione di Huffman|Compressione di Huffman]]
			1. [[#Funzione di cancellazione#Definizione|Definizione]]
			2. [[#Funzione di cancellazione#Come costruiamo le parole in codice|Come costruiamo le parole in codice]]
			3. [[#Funzione di cancellazione#Codici prefissi|Codici prefissi]]
			4. [[#Funzione di cancellazione#Costo di una codifica|Costo di una codifica]]
			5. [[#Funzione di cancellazione#Dimostrazione della sottostruttura ottima|Dimostrazione della sottostruttura ottima]]
			6. [[#Funzione di cancellazione#Implementazione|Implementazione]]
			7. [[#Funzione di cancellazione#Scelta greedy|Scelta greedy]]
49. [[#Limiti degli ordinamenti con confronti#Activity selector|Activity selector]]
			1. [[#Funzione di cancellazione#Definizione del Problema|Definizione del Problema]]
			2. [[#Funzione di cancellazione#Sottostruttura Ottima|Sottostruttura Ottima]]
			3. [[#Funzione di cancellazione#La Scelta Golosa (Greedy Choice)|La Scelta Golosa (Greedy Choice)]]
			4. [[#Funzione di cancellazione#Algoritmo Ricorsivo|Algoritmo Ricorsivo]]
			5. [[#Funzione di cancellazione#Algoritmo Iterativo|Algoritmo Iterativo]]
50. [[#Limiti degli ordinamenti con confronti#Proprietà dei grafi|Proprietà dei grafi]]
			1. [[#Funzione di cancellazione#Definizione e proprietà|Definizione e proprietà]]
			2. [[#Funzione di cancellazione#Cammino|Cammino]]
			3. [[#Funzione di cancellazione#Cammino semplice|Cammino semplice]]
			4. [[#Funzione di cancellazione#Grafo aciclico|Grafo aciclico]]
			5. [[#Funzione di cancellazione#Grafo pesato|Grafo pesato]]
			6. [[#Funzione di cancellazione#Ordinamento topologico|Ordinamento topologico]]
			7. [[#Funzione di cancellazione#Componente connessa e fortemente connessa|Componente connessa e fortemente connessa]]
			8. [[#Funzione di cancellazione#Rappresentazioni dei grafi|Rappresentazioni dei grafi]]
51. [[#Limiti degli ordinamenti con confronti#BFS|BFS]]
			1. [[#Funzione di cancellazione#Definizione|Definizione]]
			2. [[#Funzione di cancellazione#Implementazione|Implementazione]]
52. [[#Limiti degli ordinamenti con confronti#DFS|DFS]]
			1. [[#Funzione di cancellazione#Definizione|Definizione]]
			2. [[#Funzione di cancellazione#Premesse comuni alle implementazioni fatte|Premesse comuni alle implementazioni fatte]]
			3. [[#Funzione di cancellazione#Prima implementazione|Prima implementazione]]
			4. [[#Funzione di cancellazione#Seconda implementazione|Seconda implementazione]]
			5. [[#Funzione di cancellazione#Terza implementazione|Terza implementazione]]
			6. [[#Funzione di cancellazione#Etichette degli archi|Etichette degli archi]]
			7. [[#Funzione di cancellazione#Per cosa usiamo la DFS|Per cosa usiamo la DFS]]
53. [[#Limiti degli ordinamenti con confronti#Introduzione|Introduzione]]
			1. [[#Funzione di cancellazione#Definizioni|Definizioni]]
			2. [[#Funzione di cancellazione#Varianti di questo problema|Varianti di questo problema]]
54. [[#Limiti degli ordinamenti con confronti#Proprietà dei cammini minimi|Proprietà dei cammini minimi]]
			1. [[#Funzione di cancellazione#Sottostruttura ottima|Sottostruttura ottima]]
			2. [[#Funzione di cancellazione#Archi di peso negativo e cicli|Archi di peso negativo e cicli]]
			3. [[#Funzione di cancellazione#Rilassamento dei cammini minimi|Rilassamento dei cammini minimi]]
			4. [[#Funzione di cancellazione#Proprietà dei cammini minimi|Proprietà dei cammini minimi]]
55. [[#Limiti degli ordinamenti con confronti#Single-Source Shortest Path in un DAG|Single-Source Shortest Path in un DAG]]
			1. [[#Funzione di cancellazione#Generic SSSP|Generic SSSP]]
			2. [[#Funzione di cancellazione#SSSP in un grafo orientato aciclico (DAG)|SSSP in un grafo orientato aciclico (DAG)]]
56. [[#Limiti degli ordinamenti con confronti#Algoritmo di Bellam-Ford|Algoritmo di Bellam-Ford]]
			1. [[#Funzione di cancellazione#Definizione|Definizione]]
			2. [[#Funzione di cancellazione#Implementazione|Implementazione]]
			3. [[#Funzione di cancellazione#Esempio|Esempio]]
			4. [[#Funzione di cancellazione#Complessità|Complessità]]
57. [[#Limiti degli ordinamenti con confronti#Algoritmo di Dijkstra|Algoritmo di Dijkstra]]
			1. [[#Funzione di cancellazione#Definizione|Definizione]]
			2. [[#Funzione di cancellazione#Implementazione|Implementazione]]
			3. [[#Funzione di cancellazione#Esempio|Esempio]]
			4. [[#Funzione di cancellazione#Complessità|Complessità]]
58. [[#Limiti degli ordinamenti con confronti#Conclusioni sul problema dei cammini minimi da una sorgente|Conclusioni sul problema dei cammini minimi da una sorgente]]
			1. [[#Funzione di cancellazione#Conclusioni|Conclusioni]]
			2. [[#Funzione di cancellazione#Utilizzi molteplici|Utilizzi molteplici]]
59. [[#Limiti degli ordinamenti con confronti#Programmazione dinamica per la risoluzione dei cammini minimi tra tutte le coppie|Programmazione dinamica per la risoluzione dei cammini minimi tra tutte le coppie]]
			1. [[#Funzione di cancellazione#Definizione|Definizione]]
			2. [[#Funzione di cancellazione#Implementazione|Implementazione]]
			3. [[#Funzione di cancellazione#Miglioramento|Miglioramento]]
			4. [[#Funzione di cancellazione#Complessità|Complessità]]
60. [[#Limiti degli ordinamenti con confronti#Floyd-Warshall|Floyd-Warshall]]
			1. [[#Funzione di cancellazione#Definizione|Definizione]]
			2. [[#Funzione di cancellazione#Implementazione|Implementazione]]
			3. [[#Funzione di cancellazione#Esempio|Esempio]]
			4. [[#Funzione di cancellazione#Complessità|Complessità]]
