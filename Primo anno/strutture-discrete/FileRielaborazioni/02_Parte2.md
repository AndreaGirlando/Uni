3Questo file è la rielaborazione delle slide [[02_Parte2.pdf]]
...
- $φ(42) : 42 = (2^1 - 2^{1-1}) · (3^1 - 3^{1-1}) · (7^1 - 7^{1-1}) = (2^1 - 2^0) · (3^1 - 3^0) · (7^1 - 7^0)$ Quindi $φ(42) = 1 · 2 · 6 = 12$. (in questo esempio ho preferito specificare ogni singolo esponente per renderlo più semplice da capire)
