...
struct clientData {   //30 
   int account; //identificativo del conto // 4
   char lastName[12];  // stringa che contiene il cognome //12
   char firstName[10]; // stringa che contiene il nome //10
   double balance; // saldo sul conto //4
};                     
